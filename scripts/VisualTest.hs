...
main = do
    ...
    putStrLn "Inherited"
    putStrLn "========="
    putEscLn $ Underline $ BgWhite $ Blue $ ((UnderlineOff $ BgBlack $ White "-->") <> Inherited "This should be underlined, white background and blue foreground" <> (UnderlineOff $ BgBlack $ White "<---"))
    putStrLn ""
    putStrLn "Normal"
    putStrLn "========="
    putEscLn $ Underline $ BgWhite $ Blue $ (Inherited "-->" <> Normal "This should not have any attributes except for those from the terminal" <> Inherited "<---")
    putStrLn ""
    putStrLn "Blink and Blink Off"
    putStrLn "====================="
    putEscLn $ Red "This should not be blinking" <> Normal " " <> Blink <| Red "This should be blinking"
    putEscLn $ Blink $ Blue $ BlinkOff "This should be not blinking from blink off" <> Normal " " <> Inherited "This should be blinking"
    putStrLn ""
    putStrLn "Bright and Bright Off"
    putStrLn "====================="
    putEscLn $ Red "This should be dim" <> Inherited " " <> Bright <| Red "This should be bright"
    putEscLn $ Bright $ Blue $ BrightOff "This should be dim from bright off" <> Inherited " This should be bright"
    putStrLn ""
    putStrLn "Underline and Underline Off"
    putStrLn "==========================="
    putEscLn $ Red "This should not be underlined" <> Inherited " " <> Underline <| Red "This should be underlined"
    putEscLn $ Underline $ Blue $ UnderlineOff "This should not be underlined from underline off" <> Normal " " <> Inherited "This should be underlined"
    putStrLn ""
    putStrLn "Inverse and Inverse Off"
    putStrLn "==========================="
    putEscLn $ Red "This should be inverse" <> Normal " " <> Inverse <| Red "This should be inverse"
    putEscLn $ Inverse $ Blue $ InverseOff "This should not be inverse from inverse off" <> Normal " " <> Inherited "This should be inverse"
